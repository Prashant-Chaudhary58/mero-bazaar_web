...
export const RegisterForm = () => {
    ...
    useEffect(() => {
        ...
        if (roleFromUrl && ["seller", "buyer"].includes(roleFromUrl)) {
            ...
            router.replace("/auth/select-role"); // Updated route
        }
    }, [searchParams, router]);
    ...
    const onSubmit = async (data: RegisterInput) => {
        ...
        try {
            ...
            // Store user in localStorage for frontend state if returned, otherwise login handles it
            if (result.data) {
        ...
        <div className="w-full max-w-md p-4">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        {...register("fullName")}
                        className={`border rounded-md p-2 outline-none transition text-black ${errors.fullName
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        {...register("phone")}
                        type="tel"
                        className={`border rounded-md p-2 outline-none transition text-black ${errors.phone
                            ? "border-red-500 focus:ring-1 focus:ring-red-500"
                            : "border-gray-300 focus:border-green-500"
                            }`}
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        {...register("password")}
                        type="password"
                        className={`border rounded-md p-2 outline-none transition text-black ${errors.password
                            ? "border-red-500 focus:ring-1 focus:ring-red-500"
                            : "border-gray-300 focus:border-green-500"
                            }`}
                        placeholder="••••••••"
                ...
                <div className="flex flex-col gap-1">
                    ...
                    <input
                        ...
                        type="password"
                        className={`border rounded-md p-2 outline-none transition text-black ${errors.confirmPassword
                            ? "border-red-500 focus:ring-1 focus:ring-red-500"
                            : "border-gray-300 focus:border-green-500"
                            }`}
                        placeholder="••••••••"
